class Seed < ActiveRecord::Base
  ...
  def self.add_dryland_seed(name, annual_precipitation_min, salt_tolerance_level)
    Seed.create!(
      name: name,
  ...
  def self.add_irrigated_seed(name, annual_precipitation_min, salt_tolerance_level)
    Seed.create!(
      name: name,
