...
RSpec.describe SeedsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all seeds as @seeds" do
      ...
      expect(assigns(:seeds)).to eq([seed])
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new seed as @seed" do
      ...
      expect(assigns(:seed)).to be_a_new(Seed)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created seed as @seed" do
        post :create, {:seed => valid_attributes}, valid_session
        expect(assigns(:seed)).to be_a(Seed)
        expect(assigns(:seed)).to be_persisted
      end

      it "redirects to the created seed" do
        post :create, {:seed => valid_attributes}, valid_session
        expect(response).to redirect_to(Seed.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved seed as @seed" do
        post :create, {:seed => invalid_attributes}, valid_session
        expect(assigns(:seed)).to be_a_new(Seed)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested seed" do
        seed = Seed.create! valid_attributes
        put :update, {:id => seed.to_param, :seed => new_attributes}, valid_session
        seed.reload
      ...
      it "redirects to the seed" do
        seed = Seed.create! valid_attributes
        put :update, {:id => seed.to_param, :seed => valid_attributes}, valid_session
        expect(response).to redirect_to(seed)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the seed as @seed" do
        seed = Seed.create! valid_attributes
        put :update, {:id => seed.to_param, :seed => invalid_attributes}, valid_session
        expect(assigns(:seed)).to eq(seed)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the seeds list" do
      seed = Seed.create! valid_attributes
      delete :destroy, {:id => seed.to_param}, valid_session
      expect(response).to redirect_to(seeds_url)
    end
  end
